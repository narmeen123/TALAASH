...
class Example0 extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    console.log("email afer seeing" + hospitaldata.email);
    console.log("name afer seeing" + hospitaldata.name);
    console.log("password afer seeing" + hospitaldata.password);
    console.log("address afer seeing" + hospitaldata.address);
    console.log(" conf_password afer seeing" + hospitaldata.conf_password);
    console.log("phone after seeing" + hospitaldata.phone);
    const form = await axios
      .post("/api/hospital", hospitaldata)
      .then((res) => {
