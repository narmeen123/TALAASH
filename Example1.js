...
class Example1 extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    console.log("email afer seeing" + policedata.email);
    console.log("name afer seeing" + policedata.name);
    console.log("password afer seeing" + policedata.password);
    console.log("address afer seeing" + policedata.address);
    console.log(" conf_password afer seeing" + policedata.conf_password);
    console.log("phone after seeing" + policedata.phone);
    const form = await axios
      .post("/api/police", policedata)
      .then((res) => {
